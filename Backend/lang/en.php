...
$lang['sviat__checkbox__modal_advance_title'] = "Advance receipt";
$lang['sviat__checkbox__modal_advance_submit'] = "Issue receipt";
$lang['sviat__checkbox__modal_cancel'] = "Cancel";
$lang['sviat__checkbox__modal_confirm_yes'] = "Yes, continue";
$lang['sviat__checkbox__confirm_create_return'] = "A return receipt will be created at the tax authority. This cancels the order's fiscalisation and cannot be undone with a separate button.";
...
$lang['sviat__checkbox__errors_order_paid'] = "The order is already paid in full — there is nothing left to record as an advance";
...
$lang['sviat__checkbox__chain_id_settings'] = "Order number on the advance receipt";
$lang['sviat__checkbox__chain_id_help'] = "Checkbox prints this number on the advance receipt as \"Передплата за замовленням №…\". A bare order number will not do: the API requires at least 10 characters, so it is padded with a prefix or with leading zeros.";
$lang['sviat__checkbox__chain_id_limits'] = "custom_relation_id in the Checkbox schema: 10 to 256 characters, unique within the organisation. Omit it entirely and Checkbox substitutes its own number such as 1717502471, which cannot be matched to an order.";
$lang['sviat__checkbox__chain_id_format'] = "Format";
$lang['sviat__checkbox__chain_id_format_prefix'] = "Prefix and order number";
$lang['sviat__checkbox__chain_id_format_digits'] = "Digits only, leading zeros";
$lang['sviat__checkbox__chain_id_prefix'] = "Prefix";
$lang['sviat__checkbox__chain_id_preview'] = "The receipt will show";
...
$lang['sviat__checkbox__advance_hidden_by_paid'] = "No advance is offered here either: the order is already marked as paid, so there is nothing left to collect in parts. To fiscalise the money, clear the \"Order paid\" flag.";
