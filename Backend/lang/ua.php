...
$lang['sviat__checkbox__modal_advance_title'] = "Чек авансу";
$lang['sviat__checkbox__modal_advance_submit'] = "Виставити чек";
$lang['sviat__checkbox__modal_cancel'] = "Скасувати";
$lang['sviat__checkbox__modal_confirm_yes'] = "Так, продовжити";
$lang['sviat__checkbox__confirm_create_return'] = "Буде створено чек повернення в податковій. Фіскалізацію замовлення це скасовує, і окремою кнопкою повернути назад не можна.";
...
$lang['sviat__checkbox__errors_order_paid'] = "Замовлення вже оплачене повністю — авансу вносити нема з чого";
...
$lang['sviat__checkbox__chain_id_settings'] = "Номер замовлення в чеку авансу";
$lang['sviat__checkbox__chain_id_help'] = "Checkbox друкує цей номер у чеку авансу рядком «Передплата за замовленням №…». Голий номер замовлення не підходить: API вимагає щонайменше 10 символів, тож його доповнюють префіксом або нулями зліва.";
$lang['sviat__checkbox__chain_id_limits'] = "custom_relation_id у схемі Checkbox: від 10 до 256 символів, унікальний у межах організації. Якщо не передати його зовсім, Checkbox підставить власний номер на кшталт 1717502471 — звірити його з замовленням буде нічим.";
$lang['sviat__checkbox__chain_id_format'] = "Формат";
$lang['sviat__checkbox__chain_id_format_prefix'] = "Префікс і номер замовлення";
$lang['sviat__checkbox__chain_id_format_digits'] = "Лише цифри, нулі зліва";
$lang['sviat__checkbox__chain_id_prefix'] = "Префікс";
$lang['sviat__checkbox__chain_id_preview'] = "У чеку буде";
...
$lang['sviat__checkbox__advance_hidden_by_paid'] = "Аванс тут теж не пропонується: замовлення вже позначене оплаченим, тобто вносити частинами нема чого. Якщо кошти треба фіскалізувати, зніміть позначку «Замовлення оплачено».";
